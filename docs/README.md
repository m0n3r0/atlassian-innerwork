...
- `phase-6.md` — Phase 6: cross-graph search, AI-context bundling, deterministic analytics rollups, and the visibility/permission model behind `X-Innerwork-Principal`.
